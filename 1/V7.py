...
# === 1. 設定パラメータ (V9: Window Size 50ms, Hybrid Classification) ===
...
def process_emg_data(file_paths):
    ...
    print("--- Phase 1: データロードと基準値計算 (Window Size 50ms) ---")
    ...
    for df in all_data:
        ...
        for i in range(0, len(emg_data_offset_free) - WINDOW_SAMPLES + 1, STEP_SAMPLES):
            ...
            if label == "rest":
                ...
                # radial_dev, ulnar_dev を Movement に統合
                new_label = "Movement"
...
def main():
    ...
    # -----------------------------------------------------------
    print("\n--- Phase 3: SVMモデルの学習と評価 (V9: Hybrid Model) ---")
    ...
    print("\n--- SVM Onsetモデル学習開始 (V9: Hybrid Model) ---")
