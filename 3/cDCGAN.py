...
from keras.layers import Dense, Reshape, Flatten, Dropout, Input, Concatenate, BatchNormalization, Activation, LeakyReLU, LSTM, Conv1D, MaxPooling1D, TimeDistributed
...
beta_1 = {}
""".format(time_steps, feature_dim, noise_dim, condition_dim, epochs, batch_size, save_interval, learning_rate_generator, learning_rate_discriminator, beta_1)
