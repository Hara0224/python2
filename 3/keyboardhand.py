...
def main():
    ...
    while True:
        ...
        # 0-7のキーがすべて離された場合
        elif not (keyboard.is_pressed('0') or keyboard.is_pressed('1') or keyboard.is_pressed('2') or 
                keyboard.is_pressed('3') or keyboard.is_pressed('4') or keyboard.is_pressed('5') or
                keyboard.is_pressed('6') or keyboard.is_pressed('7')):
